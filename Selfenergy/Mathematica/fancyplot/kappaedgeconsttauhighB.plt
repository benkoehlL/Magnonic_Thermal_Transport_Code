...
plot 'kappaedgetauconsthighB.dat' u 1:($2) w l lw 7.5 t sprintf("$B$ = %0.2f $B_S$",0.30),'kappaedgetauconsthighB.dat' u 1:($4) w l lw 7.5 t sprintf("$B$ = %0.2f $B_S$",0.4), 'kappaedgetauconsthighB.dat' u 1:($6) w l lw 7.5 t sprintf("$B$ = %0.2f $B_S$",0.5), 'kappaedgetauconsthighB.dat' u 1:($8) w l lw 7.5 t sprintf("$B$ = %0.2f $B_S$",0.6), 'kappaedgetauconsthighB.dat' u 1:($12) w l lw 7.5 t sprintf("$B$ = %0.2f $B_S$",0.8), 'kappaedgetauconsthighB.dat' u 1:($14) w l lw 7.5 t sprintf("$B$ = %0.2f $B_S$",0.9), 'kappaedgetauconsthighB.dat' u 1:($16) w l lw 7.5 t sprintf("$B$ = %0.2f $B_S$",1.0)
