...
plot 'kappacentertauconstlowB.dat' u 1:($2) w l lw 7.5 t sprintf("$B$ = %0.2f $B_S$",0.00), 'kappacentertauconstlowB.dat' u 1:($3) w l lw 7.5 t sprintf("$B$ = %0.2f $B_S$",0.05), 'kappacentertauconstlowB.dat' u 1:($4) w l lw 7.5 t sprintf("$B$ = %0.2f $B_S$",0.10), 'kappacentertauconstlowB.dat' u 1:($5) w l lw 7.5 t sprintf("$B$ = %0.2f $B_S$",0.15), 'kappacentertauconstlowB.dat' u 1:($6) w l lw 7.5 t sprintf("$B$ = %0.2f $B_S$",0.2)
